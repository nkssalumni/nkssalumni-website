        ...
        <div class="row animated bounce ">
          ...
          <div class="col-lg-9 col-md-9 col-sm-12 d-flex justify-content-center" style="box-shadow: 0px 0px 8px  #0C0C0C;margin:5px;">
             <ul class="nav nav-pills">
                  <li class="nav-item">
                    <a class="nav-link active" href="/upload-files">Upload Recording</a>
                  </li>
                  <li class="nav-item">
        ...
        <div class = "row animated bounce" >
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 card bg-primary" id="form_div">
                ...
                <form action="" method='post' enctype="multipart/form-data">
                  ...
                  <input type="submit" class = "btn btn-warning" value="Upload Recording"/>
                </form>
            </div>
        </div>
    </div>
  ...
  <script>
      $("#menu-toggle").click(function(e) {
       ...
       $('form').submit(function(e){
        ...
        var extensions_arr = ["mp4","avi","3gp","mov","mpeg"];
        if(jQuery.inArray(ext, extensions_arr) !== -1) 
        {
            ...
            alert("You can only upload mp4, avi, 3gp, mpeg or mov file");
