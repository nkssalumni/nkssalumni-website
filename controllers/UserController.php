...
class UserController extends Controller
{
	...
	public function userDashboard(){
		...
		return Application::$app->router->renderView('user/index', $params);
	}
	...
	public function meals(){
		...
		if($method === 'get'){
			return Application::$app->router->renderView('user/students');
		}
	...
	public function trash(){
		$method = Application::$app->request->getMethod();
		if($method === 'get'){
			return Application::$app->router->renderView('user/trash');
		}
